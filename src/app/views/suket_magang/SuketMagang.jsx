...
class SuketMagang extends Component {
  constructor() {
    super();
    this.state = {
      loading: true,
  ...
  handleEdit = (param) => {
    ...
    history.push(`/edit/suket_magang/${param}`);
  };
  ...
  handleAdd = () => {
    const { history } = this.props;
    history.push('/tambah/suket_magang');
  };
    ...
    return (
      <div className="m-sm-30">
        <SimpleCard
          loading={false}
          title="Suket Magang"
          subtitle="Data Surat Keterangan Magang Kerja"
          currency=""
          saldo=""
        >
          <Fragment>
...
export default connect(mapStateToProps, mapDispatchToProps)(SuketMagang);
