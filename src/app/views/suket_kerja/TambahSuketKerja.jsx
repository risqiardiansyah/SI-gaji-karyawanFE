...
class TambahSuketKerja extends Component {
  constructor() {
    super();
    this.state = {
      nama_signer: "",
  ...
  render() {
    ...
    return (
      <div className="m-sm-30">
        <SimpleCard loading={false} title="Tambah Surat Keterangan Kerja">
...
export default connect(mapStateToProps, mapDispatchToProps)(TambahSuketKerja);
