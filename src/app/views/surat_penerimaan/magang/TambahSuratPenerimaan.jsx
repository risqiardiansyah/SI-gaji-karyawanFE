...
import { addPenerimaanMagang } from "app/redux/actions/PenerimaanActions";
...
class TambahSuratPenerimaan extends Component {
  constructor() {
    super();
    this.state = {
      nama_signer: "",
  ...
  submitData(params) {
    const { addPenerimaanMagang, history } = this.props;
    addPenerimaanMagang(params)
      .then((res) => {
        if (res.code === 0) {
          Swal.fire({
            title: "Berhasil",
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    addPenerimaanMagang: (params) => dispatch(addPenerimaanMagang(params)),
